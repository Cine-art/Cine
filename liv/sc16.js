...
function getUrlDetail(slug) {
    ...
    return "https://socolive16.cv/truc-tiep/" + slug + "/";
}
        ...
        try {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                if (poster && poster.indexOf("http") !== 0) {
                    poster = "https://socolive16.cv/wp-content/uploads/truc-tiep/logos/football/team/" + poster;
                }
                
                var backdrop = item.away_logo || "";
                if (backdrop && backdrop.indexOf("http") !== 0) {
                    backdrop = "https://socolive16.cv/wp-content/uploads/truc-tiep/logos/football/team/" + backdrop;
                }
                ...
                items.push({
                    "id": slug,
                    "title": title,
                    "posterUrl": poster || "https://socolive16.cv/wp-content/uploads/2023/11/socolive-logo.png",
                    "backdropUrl": backdrop || "https://socolive16.cv/wp-content/uploads/2023/11/socolive-logo.png",
                    "year": year,
                    "quality": "HD",
...
function parseMovieDetail(htmlContent, apiUrl) {
    ...
    var title = "Trận đấu Socolive";
    var description = "Xem trực tiếp bóng đá chất lượng cao trên Socolive.";
    var posterUrl = "https://socolive16.cv/wp-content/uploads/2023/11/socolive-logo.png";
    var rating = 8.0;
    var year = 2026;
    var servers = [];
